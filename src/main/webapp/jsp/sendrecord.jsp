            ...
            $.ajax({
                ...
                success: function (req) {
                    ...
                    $.each(req, function (i, sendRecord) {//i表示循环的下标，sendRecord表示循环的对象，可自定义名字
                        ...
                        list.append("<tr>");
                        list.append("<td style='text-align: center'>" + sendRecord.id + "</td>");
                        list.append("<td style='width:265px;text-align: center'><div class=\"cut_title ellipsis\">" + sendRecord.content + "</td>");
                        list.append("<td style='text-align: center'>" + createtime + "</td>");
                        list.append("<td style='text-align: center'>" + sendRecord.userNum + "</td>");
                        list.append("<td style='text-align: center'>");
                        list.append("<a href=\"#\">删除</a>");
//                        list.append("<a href=\"#\" class=\"inner_btn\">表内按钮</a>");
                    ...
                    var head = "    <table class=\"table\" id=\"act_table\">\n" +
                        "                    <tr>\n" +
                        "                        <th style='text-align: center'>发送ID</th>\n" +
                        "                        <th style='text-align: center'>发送内容</th>\n" +
                        "                        <th style='text-align: center'>发送时间</th>\n" +
                        "                        <th style='text-align: center'>扫描人数</th>\n" +
